...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "du1nkmp0edheyjq07rm8s1tzr4qs4ut7k24vc2ps0vzm30zp77y0",
  ...
  manifest = (
    ...
    appMarketingVersion = (defaultText = "1.0.8"),
    ...
    metadata = (
      ...
      icons = (
        ...
        appGrid = (svg = embed "../meta/icons/ideaotter_128.svg"),
        grain = (svg = embed "../meta/icons/ideaotter_24.svg"),
        market = (svg = embed "../meta/icons/ideaotter_150.svg"),
        marketBig = (svg = embed "../meta/icons/ideaotter_300.svg"),
      ),
